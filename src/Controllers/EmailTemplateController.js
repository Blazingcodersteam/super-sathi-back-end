...
class EmailTemplateController {
    ...
    static async previewTemplate(req, res) {
        try {
            ...
            // Default sample data
            const sampleData = Object.assign({ site_logo: 'https://example.com/logo.png', site_name: 'Super Sathi', site_url: 'https://supersathi.com', current_date: new Date().toLocaleDateString(), current_year: new Date().getFullYear(), user_name: 'John Doe', email: 'john.doe@example.com', phone: '+91-9876543210', profile_id: 'VH123456', login_url: 'https://supersathi.com/login', otp: '123456', plan_name: 'Gold Plus', plan_duration: '6 months', amount: '₹4,999', payment_id: 'PAY123456789', valid_until: '2024-12-31', temp_password: 'TempPass123', registration_date: new Date().toLocaleDateString(), admin_url: 'https://admin.supersathi.com', staff_name: 'Jane Smith', role_name: 'Content Manager', access_level: 'Level 2' }, variables);
